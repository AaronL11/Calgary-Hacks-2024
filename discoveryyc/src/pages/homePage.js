    ...
    <div style={{
      ...
      <main>
        ...
        <div style={{margin:"50px"}}>
            ...
            <img style={{width:"200px", height:"200px", marginTop:"10px", marginBottom:"100px", display: "block", marginLeft: "auto", marginRight:"auto"}} src={require("../Assets/castlePicture.png")} alt="City Skyline" /> 
        </div>
      </main>
    </div>
  );
